...
/**
 * Every bus must export a function by name
 * \<bus_name\>_entry of type sdi_bus_entry_callback
 * The api would return it's set of callbacks in sdi_bus_driver_t
 */
typedef sdi_bus_driver_t * (*sdi_bus_entry_callback)(void);
